...
def unzip_file(dataname):
    zip_name = './Data/Baron/' + dataname + '.zip'
    dst_dir = './Data/Baron' 
...
for i in ['Baron1','Baron2','Baron3','Baron4','Baron mouse1','Baron mouse2']:
    unzip_file(i)
human1 = pd.read_csv('./Data/Baron/GSM2230757_human1_umifm_counts.csv')
human2 = pd.read_csv('./Data/Baron/GSM2230758_human2_umifm_counts.csv')
human3 = pd.read_csv('./Data/Baron/GSM2230759_human3_umifm_counts.csv')
human4 = pd.read_csv('./Data/Baron/GSM2230760_human4_umifm_counts.csv')
mouse1 = pd.read_csv('./Data/Baron/GSM2230761_mouse1_umifm_counts.csv')
mouse2 = pd.read_csv('./Data/Baron/GSM2230762_mouse2_umifm_counts.csv')
...
adata1_1.write_h5ad('./Data/AnnData/Pancreas_human1.h5ad')
adata1_2.write_h5ad('./Data/AnnData/Pancreas_human2.h5ad')
adata1_3.write_h5ad('./Data/AnnData/Pancreas_human3.h5ad')
adata1_4.write_h5ad('./Data/AnnData/Pancreas_human4.h5ad')
adata2.write_h5ad('./Data/AnnData/Pancreas_mouse.h5ad')
