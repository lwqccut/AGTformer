...
"model": Containing model framwork of AGTformer and the framwork the GNN module, Attention module.

"preprocessing_h5.py" and "preprocessing_baron.py": Preprocessing fuction for different format.

"run.py": To perform model training and clustering analysis.
...
Usage
For applying AGTformer, the convenient way is run "run.py".
